...
def _parse_gpx(data: bytes) -> dict:
    ...
    return {
        ...
        "speed_avg": round(s_avg, 2) if s_avg is not None else None,
        "speed_max": round(s_max, 2) if s_max is not None else None,
        "speed_min": round(s_min, 2) if s_min is not None else None,
