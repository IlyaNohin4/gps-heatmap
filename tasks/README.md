...
| [T19](T19-upload-refreshes-list.md) | Список треков обновляется после загрузки/удаления | Frontend | P1 | 30-60m |
| [T20](T20-ui-spacing.md) | Выравнивание отступов UI (шкала 4/8/12/16/24) | Frontend | P2 | 2h |
